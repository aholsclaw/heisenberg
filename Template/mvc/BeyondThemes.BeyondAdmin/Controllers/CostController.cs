...
namespace BeyondThemes.BeyondAdmin.Controllers
{
    public class CostController : Controller
    {
        ...
        {
            var costs = db.Costs.Include(c => c.CostType).Include(c => c.Project);
        ...
        {
            ViewBag.CostTypeID = new SelectList(db.CostTypes, "CostTypeID", "CostTypeName");
        ...
        public ActionResult Create([Bind(Include = "CostID,ProjectID,CostTypeID,Amount,Year,Quarter,PostProject")] Cost cost)
        {
            ...
            ViewBag.CostTypeID = new SelectList(db.CostTypes, "CostTypeID", "CostTypeName", cost.CostTypeID);
            ViewBag.ProjectID = new SelectList(db.Projects, "ProjectID", "Title", cost.ProjectID);
            return View(cost);
        }
