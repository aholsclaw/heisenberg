...
namespace BeyondThemes.BeyondAdmin.Controllers
{
    public class StatusController : Controller
    {
        ...
        {
            var status = db.Status.Include(s => s.Person).Include(s => s.Project);
        ...
        public ActionResult Create([Bind(Include = "StatusID,ProjectID,PersonID,Date,StatusColor,StatusDescription")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StatusID,ProjectID,PersonID,Date,StatusColor,StatusDescription")] Status status)
        {
            if (ModelState.IsValid)
            {
